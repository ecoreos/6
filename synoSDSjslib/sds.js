...
Ext.define("SYNO.SDS._System", {
    ...
    _rebootSystem: function(c, a, b) {
        ...
        this.getMsgBox().show({
            ...
            maxWidth: 300,
            title: _D("product"),
            msg: (true === b) ? _T("login", "error_system_getting_ready") : _JSLIBSTR("uicommon", "system_reboot").replace(/eC6017393/g, _D("product"))
        });
        if (false === c && false === a) {
            d = "skip_cmd"
        } else {
                ...
                failure: function(i, h) {
                    ...
                    if (!h.timeoutNotified && (g - h.startTime) > h.timeLimit) {
                        this.getMsgBox().show({
                            ...
                            maxWidth: 300,
                            title: _D("product"),
                            msg: _JSLIBSTR("uicommon", "system_reboot_timeout").replace(/eC6017393/g, _D("product"))
                        });
    ...
    _shutdownSystem: function(a) {
        this.getMsgBox().show({
            ...
            maxWidth: 300,
            title: _D("product"),
            msg: _JSLIBSTR("uicommon", "system_poweroff").replace(/eC6017393/g, _D("product"))
        });
        ...
        d = {
            ...
            items: [{
                ...
                items: [{
                    ...
                    xtype: "box",
                    cls: "about-ip",
                    html: String.format("<b>{0}: </b>{1}", _T("common", "osname"), _S("majorversion") + "." + _S("minorversion") + "-" + _S("version"))
                }]
            }],
            bbar: [{
                xtype: "box",
